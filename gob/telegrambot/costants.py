...
WARNING_LOCATION = ("Сюда стоит слать только адрес или свои "
                    "координаты по кнопочке с клавиатуры")
HERE_IS_NOTHING_MESSAGE = ("Тут ничего нет, совсем. Или Ваш город "
                           "не поддерживается")
NO_TYPING_HERE_MESSAGE = ("Не нужно сюда ничего печатать, жмите кнопочки на "
                          "клавиатуре!")
